...
def run_replication(Tp, N, rep, tuning: Tuning, *, oracle=False,
    ...
    rec["_opt_warm_start_objective_mean"] = float(res.diagnostics.get("first_stage_warm_start_objective_mean", float("nan")))
    rec["_opt_best_objective_mean"] = float(res.diagnostics.get("first_stage_best_objective_mean", float("nan")))
    rec["_opt_mean_sweeps"] = float(res.diagnostics.get("first_stage_n_sweeps_mean", float("nan")))
    rec["_opt_mean_final_relative_objective_decrease"] = float(res.diagnostics.get("first_stage_final_relative_objective_decrease_mean", float("nan")))
    rec["_opt_frac_final_decrease_lt_1e_6"] = float(res.diagnostics.get("first_stage_final_decrease_lt_1e_6_rate", float("nan")))
    rec["_opt_frac_final_decrease_lt_1e_5"] = float(res.diagnostics.get("first_stage_final_decrease_lt_1e_5_rate", float("nan")))
    rec["_opt_mean_stationarity_residual"] = float(res.diagnostics.get("first_stage_stationarity_residual_mean", float("nan")))
    rec["_opt_mean_relative_restart_improvement"] = float(res.diagnostics.get("first_stage_relative_restart_improvement_mean", float("nan")))
    rec["_opt_frac_restart_improve_gt_1e_6"] = float(res.diagnostics.get("first_stage_restart_improvement_gt_1e_6_rate", float("nan")))
    rec["_opt_frac_restart_improve_gt_1e_4"] = float(res.diagnostics.get("first_stage_restart_improvement_gt_1e_4_rate", float("nan")))
    rec["_opt_monotone_rate"] = float(res.diagnostics.get("first_stage_monotone_rate", float("nan")))
    rec["_opt_stopped_before_sweep_cap_rate"] = float(res.diagnostics.get("first_stage_stopped_before_sweep_cap_rate", float("nan")))
    rec["_opt_sweep_cap_hit_rate"] = float(res.diagnostics.get("first_stage_sweep_cap_hit_rate", float("nan")))
    rec["_opt_convergence_failure_rate"] = float(res.diagnostics.get("first_stage_convergence_failure_rate", float("nan")))
    rec["_opt_max_iteration_hit_rate"] = float(res.diagnostics.get("first_stage_max_iteration_hit_rate", float("nan")))
    rec["_rank_selection_fit_diagnostics_available"] = bool(
        res.diagnostics.get("rank_selection_fit_diagnostics_available", False))
    if "rank_selection_fit_diagnostics_todo" in res.diagnostics:
        rec["_rank_selection_fit_diagnostics_todo"] = res.diagnostics["rank_selection_fit_diagnostics_todo"]
...
def aggregate(path) -> Dict[str, dict]:
    ...
    out["_meta"] = dict(retained=float(np.nanmean(ret)),
                        ...
                        optimization_mean_relative_restart_improvement=_meta_mean("_opt_mean_relative_restart_improvement"),
                        optimization_frac_restart_improve_gt_1e_6=_meta_mean("_opt_frac_restart_improve_gt_1e_6"),
                        optimization_frac_restart_improve_gt_1e_4=_meta_mean("_opt_frac_restart_improve_gt_1e_4"),
                        optimization_monotone_rate=_meta_mean("_opt_monotone_rate"),
                        optimization_sweep_cap_hit_rate=_meta_mean("_opt_sweep_cap_hit_rate"),
                        optimization_stopped_before_sweep_cap_rate=_meta_mean("_opt_stopped_before_sweep_cap_rate"),
                        optimization_mean_final_relative_objective_decrease=_meta_mean("_opt_mean_final_relative_objective_decrease"),
                        optimization_frac_final_decrease_lt_1e_6=_meta_mean("_opt_frac_final_decrease_lt_1e_6"),
                        optimization_frac_final_decrease_lt_1e_5=_meta_mean("_opt_frac_final_decrease_lt_1e_5"),
                        optimization_max_iteration_hit_rate_alias="optimization_sweep_cap_hit_rate",
                        optimization_convergence_failure_rate_alias="optimization_sweep_cap_hit_rate",
                        optimization_convergence_failure_rate=_meta_mean("_opt_convergence_failure_rate"),
                        optimization_max_iteration_hit_rate=_meta_mean("_opt_max_iteration_hit_rate"),
                        optimization_mean_stationarity_residual=_meta_mean("_opt_mean_stationarity_residual"),
                        optimization_mean_stationarity_residual_alias="optimization_mean_final_relative_objective_decrease",
