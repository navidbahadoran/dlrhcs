...
def run_ar2(Ymat, tuning: Tuning, groups=None, group_labels=("g0", "g1"),
    ...
    derived["solver"] = dict(monotone=bool(res.diagnostics.get("monotone", True)),
                             ...
                             retained_total=float(res.diagnostics.get("retained_total", float("nan"))),
                             retained_nonvalidation=float(res.diagnostics.get("retained_nonvalidation", float("nan"))),
                             retained_nonvalidation_min=float(res.diagnostics.get("retained_nonvalidation_min", float("nan"))),
                             retained_nonvalidation_max=float(res.diagnostics.get("retained_nonvalidation_max", float("nan"))),
                             validation_fold_size_mean=float(res.diagnostics.get("validation_fold_size_mean", float("nan"))),
                             validation_fold_share_mean=float(res.diagnostics.get("validation_fold_share_mean", float("nan"))),
                             retained_alias="retained_nonvalidation",
                             J_realized=int(res.diagnostics.get("J_realized", res.J)),
                             J_min=int(res.diagnostics.get("J_min", 0)),
                             c_J=float(res.diagnostics.get("c_J", float("nan"))),
                             J_rule_term=int(res.diagnostics.get("J_rule_term", 0)),
                             J_manual_override=bool(res.diagnostics.get("J_manual_override", False)),
                             B_TN_fold_rule=float(res.diagnostics.get("B_TN_fold_rule", float("nan"))),
                             L_TN_J=float(res.diagnostics.get("L_TN_J", float("nan"))),
